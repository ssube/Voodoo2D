...
public class ResourceManager {
    ...
    public void reload()
    {
        ...
        if (spriteHandle != null) { spriteDir = spriteHandle.file(); }
        ...
        if (tilesetHandle != null) { tilesetDir = tilesetHandle.file(); }
        ...
        if (templateHandle != null) { templateDir = templateHandle.file(); }
